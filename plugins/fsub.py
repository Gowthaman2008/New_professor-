...
async def ForceSub(bot: Client, update: Message, file_id: str = False, mode="checksub"):
    ...
    try:
        ...
        text="""**❗️ꜰɪʀꜱᴛ 𝙲𝙻𝙸𝙲𝙺 ʀᴇ𝚀ᴜᴇꜱᴛ ᴛᴏ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ 👇 /n/n 📥 ᴀꜰᴛᴇʀ ᴄʟɪᴄᴋ & ɢɪᴠᴇᴅ ʀᴇ𝚀ᴜᴇꜱᴛ ᴛᴏ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ ᴄᴏᴍᴇʙᴀᴄᴋ ᴛᴏ ᴛʜɪꜱ ʙᴏᴛ👇 ᴄʟɪᴄᴋ ᴛʀʏ ᴀɢᴀɪɴ ʙᴜᴛᴛᴏɴ ʏᴏᴜʀ ᴀꜱᴋᴇᴅ ꜰɪʟᴇ ᴡɪʟʟ ᴄᴏᴍᴇ ✅**"""
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("❤️ Try Now ❤️ ", callback_data=f"{mode}#{file_id}")
            ]
        ]
